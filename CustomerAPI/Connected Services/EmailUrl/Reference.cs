...
namespace EmailUrl
{
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="EmailUrl.ServiceSoap")]
    public interface ServiceSoap
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/sendemail", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<string> sendemailAsync(string tomail, string toname, string frommail, string fromname, string subjt, string body);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("dotnet-svcutil", "1.0.0.1")]
    public interface ServiceSoapChannel : EmailUrl.ServiceSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("dotnet-svcutil", "1.0.0.1")]
    public partial class ServiceSoapClient : System.ServiceModel.ClientBase<EmailUrl.ServiceSoap>, EmailUrl.ServiceSoap
    {
    ...
    static partial void ConfigureEndpoint(System.ServiceModel.Description.ServiceEndpoint serviceEndpoint, System.ServiceModel.Description.ClientCredentials clientCredentials);
        ...
        public System.Threading.Tasks.Task<string> sendemailAsync(string tomail, string toname, string frommail, string fromname, string subjt, string body)
        {
            return base.Channel.sendemailAsync(tomail, toname, frommail, fromname, subjt, body);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.ServiceSoap))
            {
                return new System.ServiceModel.EndpointAddress("https://online.manappuram.com/SendMail/Service.asmx");
            }
            if ((endpointConfiguration == EndpointConfiguration.ServiceSoap12))
            {
                return new System.ServiceModel.EndpointAddress("https://online.manappuram.com/SendMail/Service.asmx");
