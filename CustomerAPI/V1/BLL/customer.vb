...
Public Class customer
    ...
    Public Function NewcustomeraddPhoto(ByVal custid As String, ByVal cust_photo() As Byte, ByVal add_photo() As Byte, ByVal kyc_photo() As Byte, ByVal neftphoto() As Byte) As String
        ...
        If Not IsNothing(cust_photo) Then
            sql = "update aml_gloan.customer_photo set pledge_photo=:ph where cust_id='" & custid & "'"
        ...
        If Not IsNothing(add_photo) Then
            sql = "update aml_gloan.customer_photo set kyc_photo=:ph1 where cust_id='" & custid & "'"
        ...
        If Not IsNothing(kyc_photo) Then
            sql = "update aml_gloan.customer_photo set add_photo=:ph2 where cust_id='" & custid & "'"
    ...
    Public Function AddCustomerPhoto(ByVal custid As String, ByVal cust_photo() As Byte, ByVal stat As Integer) As String
        ...
        If stat = 1 Then
            Try
                ods = oh.ExecuteDataSet("select count(*) from aml_gloan.customer_photo where cust_id='" & custid & "'")
                If ods.Tables(0).Rows(0)(0) > 0 Then
                    oh.ExecuteNonQuery("insert into dms.aml_gloan.customer_photo_his select t.*,sysdate from aml_gloan.customer_photo t where cust_id='" & custid & "'")
                    Dim sql1 As String = "update aml_gloan.customer_photo set pledge_photo=:ph where cust_id='" & custid & "'"
                    Dim parm1(0) As OracleParameter
                    parm1(0) = New OracleParameter
                    ...
                    message = "Complete2"
                Else
                    oh.ExecuteNonQuery("insert into aml_gloan.customer_photo (cust_id) values ('" & custid & "')")
                    Dim sql As String = "update aml_gloan.customer_photo set pledge_photo=:ph where cust_id='" & custid & "'"
                    Dim parm(0) As OracleParameter
                    parm(0) = New OracleParameter
                    parm(0).ParameterName = "ph"
                    parm(0).OracleType = OracleType.Blob
        ...
        Else
            Try
                ...
                If ods.Tables(0).Rows(0)(0) > 0 Then
                    oh.ExecuteNonQuery("insert into dms.aml_gloan.customer_photo_his select t.*,sysdate from aml_gloan.customer_photo t where cust_id='" & custid & "'")
                    Dim sql1 As String = "update aml_gloan.customer_photo set kyc_photo=:ph where cust_id='" & custid & "'"
                    Dim parm1(0) As OracleParameter
                    parm1(0) = New OracleParameter
                    parm1(0).ParameterName = "ph"
                    parm1(0).OracleType = OracleType.Blob
                ...
                Else
                    oh.ExecuteNonQuery("insert into aml_gloan.customer_photo (cust_id) values ('" & custid & "')")
                    Dim sql As String = "update aml_gloan.customer_photo set kyc_photo=:ph where cust_id='" & custid & "'"
                    Dim parm(0) As OracleParameter
                    parm(0) = New OracleParameter
                    parm(0).ParameterName = "ph"
                    parm(0).OracleType = OracleType.Blob
